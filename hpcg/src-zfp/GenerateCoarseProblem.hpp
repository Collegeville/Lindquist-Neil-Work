...
void GenerateCoarseProblem(const SparseMatrix<Datatype> & Af) {
  ...
  SparseMatrix<Datatype> * Ac = new SparseMatrix<Datatype>;
  InitializeSparseMatrix(*Ac, geomc);
  GenerateProblem(*Ac, (Vector<Datatype>*)0, (Vector<Datatype>*)0, (Vector<Datatype>*)0);
  SetupHalo(*Ac);
