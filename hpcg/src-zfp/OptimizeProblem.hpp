...
float OptimizeProblemMemoryUse(const SparseMatrix<Datatype> & A) {
...
int OptimizeProblem(SparseMatrix<DatatypeA> & A, CGData<DatatypeA> & data, Vector<DatatypeB> & b, Vector<DatatypeX> & x, Vector<DatatypeX> & xexact) {
