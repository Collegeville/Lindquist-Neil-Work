...
function conjugate_gradient!(x::MultiVector{Data, GID, PID, LID}, A,
	...
	The reason for this has not been determined, but is suspected to be related to Julia relying more heavily on cache and the operating system not having extra cores to run it's other processes on.
	...
	\begin{figure}
		...
		\Description{
			...
			JuliaPetra noticably underperforms Epetra for low numbers of processes, but roughly matches the performance of Epetra when the number of processes is around 15.
		}
	\end{figure}
