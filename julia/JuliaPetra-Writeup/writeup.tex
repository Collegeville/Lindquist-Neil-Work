...
\begin{document}
	...
	\begin{table}
		\begin{tabular}{|c c|S|S|S||S|}
			...
			\hline
			100,000			&Average & 0.22850 & 0.18045 & 124.322 & 1.26633 \\
			equations		&Minimum & 0.22768 & 0.13394 & 123.324 & 1.69985 \\
			&Maximum & 0.22933 & 0.21588 & 126.464 & 1.06232 \\
			\hline
			1,000,000		&Average & 2.82589 & 2.35860 & 1149.26 & 1.19812 \\
			...
			\hline
			100,000			&Average & 0.54401 & 0.55244 & 2569.82 & 0.98474 \\
			...
			\hline
			10,000,000		&Average & 73.4730 & 73.9551 & {-} & 0.99348 \\
	...
	\todo[inline]{
		The timing results could be a bit confusing to the reader.  It would be worth mentioning specifically what the total number of equations is, at least in the description.  Also, it would be good to get some timing results from something beyond a tridiagonal matrix.
	}
	...
	Note that the table displays multiple size problems for different numbers of processors.
	...
	This seems to imply that JuliaPetra is slower for the actual computations, but the communication for larger problems overcomes the difference.
	...
	\begin{figure}
		...
		\end{loglogaxis}
		\end{tikzpicture}
		\caption{Problem Size Versus Time}
	...
	\begin{figure}
		...
		\end{axis}
		\end{tikzpicture}
		\caption{Number of Processors Versus Time}
