...
\begin{document}
	...
	\begin{figure}
		...
		\addplot[color=black,mark=*] coordinates{(100000,0.22514)(1000000,2.76858)(10000000,30.8755)};
		\addlegendentry{4 Processes, JuliaPetra}
		\addplot[color=gray,mark=*]  coordinates{(100000,0.19244)(1000000,2.35595)(10000000,24.7034)};
		\addlegendentry{4 Processes, Epetra}
		\addplot[color=black,mark=triangle*] coordinates{(100000,0.53649)(1000000,7.51502)(10000000,74.2079)};
		\addlegendentry{16 Processes, JuliaPetra}
		\addplot[color=gray,mark=triangle*]  coordinates{(100000,0.50143)(1000000,7.40649)(10000000,73.9740)};
		\addlegendentry{16 Processes, Epetra}
		\addplot[color=black,mark=diamond*] coordinates{(100000,0.77256)(1000000,9.89883)(10000000,97.4143)};
		\addlegendentry{20 Processes, JuliaPetra}
		\addplot[color=gray,mark=diamond*]  coordinates{(100000,0.70583)(1000000,9.22033)(10000000,92.1464)};
	...
	\begin{figure}
		...
		\addplot[color=black,mark=*] coordinates{(4,0.22514)(16,0.53649)(20,0.77256)};
		\addlegendentry{100,000 rows, JuliaPetra}
		\addplot[color=gray,mark=*]  coordinates{(4,0.19244)(16,0.50143)(20,0.70583)};
		\addlegendentry{100,000 rows, Epetra}
		\addplot[color=black,mark=triangle*] coordinates{(4,2.76858)(16,7.51502)(20,9.89883)};
		\addlegendentry{1,000,000 rows, JuliaPetra}
		\addplot[color=gray,mark=triangle*]  coordinates{(4,2.35595)(16,7.40649)(20,9.22033)};
		\addlegendentry{1,000,000 rows, Epetra}
		\addplot[color=black,mark=diamond*] coordinates{(4,30.8755)(16,74.2079)(20,97.4143)};
		\addlegendentry{10,000,000 rows, JuliaPetra}
		\addplot[color=gray,mark=diamond*]  coordinates{(4,24.7034)(16,73.9740)(20,92.0917)};
	...
	The \snippet{mpiexec} command was used to start the MPI processes with the \snippet{-bind-to core} and \snippet{-map-by core} flags.
