function [x,flag,relres,iter,resvec] = dpcg(A,b,tol,maxit,M1,M2,x0,varargin)
%DPCG   double Preconditioned Conjugate Gradients Method.
% the pure-double precision version of spcg
%
...
%use transpose of A for the rest, since its only doubleMatvec calls
AT = A';
